...
jQuery(function($) {
    ...
    /*--------------------------------
        Easy PIE
     --------------------------------*/
    CRYPTOKIT_SETTINGS.dbEasyPieChart = function() {
    ...
    /*--------------------------------
        Morris 
     --------------------------------*/
    CRYPTOKIT_SETTINGS.dbMorrisChart = function() {
    ...
    /*--------------------------------
        Rickshaw charts
     --------------------------------*/
    CRYPTOKIT_SETTINGS.dbRickshawChart = function() {
    ...
    /*--------------------------------
         gauge meter
     --------------------------------*/
    CRYPTOKIT_SETTINGS.dbGaugemeter = function() {
    ...
    $(document).ready(function() {
        ...
        //CRYPTOKIT_SETTINGS.dbEasyPieChart();
        CRYPTOKIT_SETTINGS.dbMorrisChart();
        //CRYPTOKIT_SETTINGS.dbRickshawChart();
        //CRYPTOKIT_SETTINGS.dbGaugemeter();
    });
